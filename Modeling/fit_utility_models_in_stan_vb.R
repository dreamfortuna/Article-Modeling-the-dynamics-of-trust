...
dir_fits <- paste(base_dir,filesep,'Modeling',filesep,'Stan_fits_27-3seeds_U',sep="")
...
subjects <- c('001','002','003','004','005','006','007','008','009','010','011','012','013','014','015','016','017','019','021','022','023','024','025','026','027','028','029')
Niter <- 8000
Nreruns <- 3
outsamp <- 500
seedz <- c('1','2','3')
...
for (m in 1:length(models)) {
  ...
  data <- auto_name_list(Nblocks=Nblocks, maxTrials=Ntrials, Ns=Nsubjects, subNtrials=subNtrials,
               ...
               mu_powerL_prior_mu, mu_powerL_prior_sd, mu_powerL_lb, mu_powerL_ub, sd_powerL_lb, sd_powerL_ub,
               mu_powerG_prior_mu, mu_powerG_prior_sd, mu_powerG_lb, mu_powerG_ub, sd_powerG_lb, sd_powerG_ub,
               mu_averse_prior_mu, mu_averse_prior_sd, mu_averse_lb, mu_averse_ub, sd_averse_lb, sd_averse_ub)
