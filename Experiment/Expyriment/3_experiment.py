...
total_reward = 0
# Define the current trial counter
experiment_count = 0
...
for i_trial in range(N_TRIALS):
    ...
    probabilities = [0.9, 0.1]  # 90% successful obstacle avoidance (.1.mpg), 10% failed obstacle avoidance (.2.mpg)
    ...
    if trust == 1:
        ...
        feedback_value = present_ai_result(0.9)
