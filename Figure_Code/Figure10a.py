...
DATA_PATH = BASE_DIR.parent / "Figure_Source_Data" / "Figure10a.txt"
OUTPUT_PATH = BASE_DIR / "Figure" / "Figure10a.svg"
...
for ax, ability in zip(axes, ABILITY_ORDER):
    ...
    ax.set_ylabel("P(Trust)", fontsize=AXIS_LABEL_SIZE, fontweight="bold")
...
axes[-1].legend(loc="lower right", fontsize=LEGEND_SIZE, frameon=False)
fig.text(0.01, 0.93, "(a)", fontsize=PANEL_LABEL_SIZE, fontweight="bold")
